...
class TemplateModule:
  ...
  def __init__(self):
    ...
    self.Type = "Html"
    self.Info = """A very intergrated CFO bonus policy update to the target. This template requires
                  a large ammount of data / OSINT to build."""
    self.Sophistication = "High" 
    self.SampleImage = str('''Modules/Sample/CFOBonusStructure.png''')
    self.TemplatePath = str('''Modules/EmailTemplates/CFOBonusStructure.email''')
